...
SYSTEM_ASK_QUESTION = """You are an expert AI tutor assessing a student's understanding of a concept.
...
SYSTEM_EVALUATE_RESPONSE = """You are an expert AI tutor evaluating a student's answer.
...
SYSTEM_PROVIDE_EXAMPLE = """You are an expert AI tutor providing a concrete example to help a student understand a concept.
...
PROMPT_ASK_QUESTION = """You just taught this concept:
{teaching_content}
...
PROMPT_EVALUATE_RESPONSE = """Concept taught: {concept_title}
...
PROMPT_PROVIDE_EXAMPLE = """Concept: {concept_title}
Concept description: {concept_description}
